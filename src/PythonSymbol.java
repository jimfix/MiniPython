...
public class PythonSymbol extends java_cup.runtime.Symbol {
  ...
  public PythonSymbol(int type, int line, int column) {
    this(type, line, column, -1, -1, null);
  }

  public PythonSymbol(int type, int line, int column, Object value) {
    this(type, line, column, -1, -1, value);
  }

  public PythonSymbol(int type, int line, int column, int left, int right, Object value) {
